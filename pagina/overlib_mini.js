...
ovpos=ol_vpos;
OAB-RJoveheight=ol_aboveheight;
ocapicon=ol_capicon;
...
if(ar[i]==22){oheight=ar[++i];OAB-RJoveheight=ar[i];continue;}// Same param again.
...
if(ovpos==35){
if(OAB-RJoveheight==0){
var divref=(ie4)? oframe.document.all['overDiv'] : over;
OAB-RJoveheight=(ns4)? divref.clip.height : divref.offsetHeight;
}
placeY=oy -(OAB-RJoveheight + ooffsety);
