...
procedure TFicha_f.medFichaExit(Sender: TObject);
begin
  inherited;
  ...
  pagecontrol1.ActivePage      := tsAndamento;
  ...
  begin
    ...
    begin
      qrySocios.Close;
      messagedlg('Codigo de Ficha não Cadastrado ou não é de Abertura/Alteração',mtInformation,[mbOk],0);
      medFicha.SetFocus;
      exit;
    end
    else
...
procedure TFicha_f.BitBtn2Click(Sender: TObject);
var cod:integer;
begin
  inherited;
...
procedure TFicha_f.BitBtn1Click(Sender: TObject);
begin
  inherited;
  ...
  qryFicha.FieldByName('tipo_processo').AsString      := 'A';
...
procedure TFicha_f.FormCreate(Sender: TObject);
begin
  inherited;
  PrimeiraVez         := False;
...
procedure TFicha_f.BitBtn3Click(Sender: TObject);
var cod : Integer;
begin
  inherited;
...
procedure TFicha_f.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
  if qryFicha.State = dsInsert then
  begin
  ...
  try
    Ficha_Soc_f.qrySocio.Close;
    Ficha_Soc_f.qrySocio.ParamByName('Cod_Ficha').AsInteger := qrySocios.fieldbyname('Cod_Ficha').AsInteger;
    Ficha_Soc_f.qrySocio.ParamByName('Cod_Socio').AsInteger := qrySocios.fieldbyname('Cod_Socio').AsInteger;
    Ficha_Soc_f.qrySocio.Open;
    if BitBtn3.Enabled then
      Ficha_Soc_f.qrySocio.edit;
    Ficha_Soc_f.Show;
  except
    Ficha_Soc_f := TFicha_Soc_f.Create(Self);
    Ficha_Soc_f.Show;
...
procedure TFicha_f.BitBtn5Click(Sender: TObject);
begin
  inherited;
  if Nivel <= 1 then
  begin
...
procedure TFicha_f.SpeedButton2Click(Sender: TObject);
begin
  inherited;
  ...
  dmPesq.pesFicha.StringSql.ADD(' WHERE (TIPO_PROCESSO=''A'' or TIPO_PROCESSO=''T'') ');
...
procedure TFicha_f.BitBtn4Click(Sender: TObject);
var ArqTmp  : TextFile;
...
procedure TFicha_f.BitBtn6Click(Sender: TObject);
begin
  inherited;
  qryAndamento.Insert;
...
procedure TFicha_f.BitBtn7Click(Sender: TObject);
begin
  inherited;
...
procedure TFicha_f.PageControl1Change(Sender: TObject);
begin
  inherited;
...
procedure TFicha_f.calcTaxaExit(Sender: TObject);
begin
  inherited;
  calcTotal.Value := calcTaxa.Value + calcServico.Value + calcOutro.Value;
end;

procedure TFicha_f.BitBtn8Click(Sender: TObject);
var x   : integer;
    cod : Integer;
begin
  inherited;
...
procedure TFicha_f.SpeedButton4Click(Sender: TObject);
begin
...
procedure TFicha_f.SpeedButton3Click(Sender: TObject);
var sSql : String;
begin
...
procedure TFicha_f.medContaExit(Sender: TObject);
begin
  inherited;
  if esc then
  begin
...
procedure TFicha_f.medPlanoExit(Sender: TObject);
begin
  inherited;
  if esc then
  begin
...
procedure TFicha_f.DBGrid3Exit(Sender: TObject);
begin
  inherited;
...
procedure TFicha_f.sbPesqClick(Sender: TObject);
begin
  inherited;
...
procedure TFicha_f.medClienteExit(Sender: TObject);
begin
  inherited;
  if esc then
  begin
...
procedure TFicha_f.Cliente1Click(Sender: TObject);
begin
  inherited;
