...
type
  TqrAndamentoLegal_f = class(TQuickRep)
    QRBand1: TQRBand;
    QRBand3: TQRBand;
    Query1: TQuery;
    QRLabel1: TQRLabel;
...
var
  qrAndamentoLegal_f: TqrAndamentoLegal_f;

implementation
uses principal;
{$R *.DFM}

procedure TqrAndamentoLegal_f.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqrAndamentoLegal_f.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
