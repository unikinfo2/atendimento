inherited CadAssunto_f: TCadAssunto_f
  Left = 296
  Top = 149
  Width = 548
  Height = 248
  Caption = 'Cadastro de Assuntos Pr'#233'-Definidos'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object Label2: TLabel [2]
    ...
    Width = 89
    Height = 13
    Caption = 'Descri'#231#227'o Assunto'
  end
  ...
  object Label5: TLabel [6]
    ...
    Width = 103
    Height = 13
    Caption = 'Classifica'#231#227'o Assunto'
  end
  ...
  object DBMemo1: TDBMemo [13]
    ...
    Width = 523
    Height = 65
    DataField = 'DESC_ASSUNTO'
    DataSource = dsAssunto
    MaxLength = 250
    TabOrder = 2
  end
  object edtClassif: TEdit [14]
    Left = 117
    Top = 18
    Width = 120
    Height = 21
  ...
  object qryAssunto: TQuery
    DatabaseName = 'db'
    RequestLive = True
    SQL.Strings = (
      'SELECT * FROM GC_ASSUNTO WHERE COD_ASSUNTO = :COD_ASSUNTO')
    Left = 352
    Top = 88
    ParamData = <
      item
